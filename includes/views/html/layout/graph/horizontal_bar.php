  ...
  <div class="horizontal_bar_outline">
    ...
    <? if($set_function):?>    
      <img 
        ...
        onmouseup="  updateGraphHorizontalBar(event, '<?=$id?>', false, '<?=$set_function?>')" 
        onmouseout=" updateGraphHorizontalBar(event, '<?=$id?>', false, '<?=$set_function?>')" 
        onmousedown="updateGraphHorizontalBar(event, '<?=$id?>', true, '<?=$set_function?>')"
